...
let uid = String(Math.floor(Math.random() * 1000)); //Id for all connected users
...
let peerConnection; //stores peer connection info
...
let toggleCamera = async () => {
    ...
    if (videoTrack.enabled){
        ...
        document.getElementById('camera-btn').classList.replace('btn-primary', 'btn-danger');
    }
    else{
        videoTrack.enabled = true;
        document.getElementById('camera-btn').classList.replace('btn-danger', 'btn-primary');
    }
}
